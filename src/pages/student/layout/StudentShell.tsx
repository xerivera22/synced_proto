...
const StudentShell = () => {
  ...
  const searchItems = useMemo(
    () => [
      { id: 'nav-overview', kind: 'Page', title: 'Overview', subtitle: 'Dashboard summary', to: '/student/overview' },
      { id: 'nav-progress', kind: 'Page', title: 'Academic Progress', subtitle: 'Grades and subjects', to: '/student/progress' },
      { id: 'nav-attendance', kind: 'Page', title: 'Attendance', subtitle: 'Daily and monthly records', to: '/student/attendance' },
      { id: 'nav-schedule', kind: 'Page', title: 'Schedule', subtitle: 'Classes and timetable', to: '/student/schedule' },
      { id: 'nav-payments', kind: 'Page', title: 'Payments', subtitle: 'Tuition and fees', to: '/student/payments' },
      { id: 'nav-documents', kind: 'Page', title: 'Documents', subtitle: 'IDs, forms, certificates', to: '/student/documents' },
      { id: 'nav-profile', kind: 'Page', title: 'Profile', subtitle: 'Personal information', to: '/student/profile' },
      { id: 'nav-settings', kind: 'Page', title: 'Settings', subtitle: 'Preferences and privacy', to: '/student/settings' },
    ],
    []
  );
                  ...
                  <div className="profile-menu" role="menu">
                    <div className="profile-meta" aria-hidden="true">
                      ...
                      <div className="profile-texts">
                        <div className="profile-name">{user?.email?.split('@')[0] || 'Student'}</div>
