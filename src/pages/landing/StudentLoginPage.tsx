          ...
          <div className="relative bg-white p-10 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between items-center mb-6 mt-4 w-full">
                ...
                <button
                  type="button"
                  onClick={() => console.log("TODO: implement password reset flow")}
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-blue-500 text-white border-0 rounded-lg text-base font-semibold cursor-pointer hover:bg-blue-600 shadow"
              >
                Login
              </button>
