        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted mb-8">
              Welcome back, Parent. You have successfully logged into SyncED.
            </p>
            <div className="flex gap-4 justify-center">
              <button
                type="button"
                className="bg-primary text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary-dark"
              >
                View Child's Grades
              </button>
              <button
                type="button"
                className="bg-gray-200 text-text px-8 py-4 rounded-lg font-semibold hover:bg-gray-300"
              >
                Attendance
              </button>
            </div>
